...
import com.cm.media.ui.widget.player.controller.TCVodControllerFloat;
import com.cm.media.ui.widget.player.controller.TCVodControllerLarge;
import com.cm.media.ui.widget.player.controller.TCVodControllerSmall;
import com.cm.media.ui.widget.player.util.NetWatcher;
import com.cm.media.ui.widget.player.util.SuperPlayerUtil;
import com.cm.media.ui.widget.player.view.TCVideoQulity;
...
public class SuperPlayerView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener {
    ...
    public boolean onBackKeyPressed() {
        if (getPlayMode() == SuperPlayerConst.PLAYMODE_FULLSCREEN) {
    ...
    private TCVodControllerBase.VodController mVodController = new TCVodControllerBase.VodController() {
        ...
        public void onBackPress(int playMode) {
            ...
            if (playMode == SuperPlayerConst.PLAYMODE_FULLSCREEN) {
                if (mPlayerViewCallback != null) {
                    mPlayerViewCallback.onQuit(SuperPlayerConst.PLAYMODE_FULLSCREEN);
                }
                mVodController.onRequestPlayMode(SuperPlayerConst.PLAYMODE_WINDOW);
            }
            // 当前是窗口模式，返回退出播放器
...
//        popupWindow.setFocusable(true);
        popupWindow.showAtLocation(this, Gravity.TOP, 1800, 300);
