package com.cm.media.ui.widget.player.controller;
...
import com.cm.media.ui.widget.player.util.VideoGestureUtil;
import com.cm.media.ui.widget.player.view.TCPointSeekBar;
import com.cm.media.ui.widget.player.view.TCVideoProgressLayout;
import com.cm.media.ui.widget.player.view.TCVideoQulity;
import com.cm.media.ui.widget.player.view.TCVolumeBrightnessProgressLayout;
        ...
        mVideoGestureUtil.setVideoGestureListener(new VideoGestureUtil.VideoGestureListener() {
            ...
            public void onBrightnessGesture(float newBrightness) {
                if (mGestureVolumeBrightnessProgressLayout != null) {
                    ...
                    mGestureVolumeBrightnessProgressLayout.setImageResource(R.mipmap.ic_light_max);
            ...
            public void onVolumeGesture(float volumeProgress) {
                if (mGestureVolumeBrightnessProgressLayout != null) {
                    mGestureVolumeBrightnessProgressLayout.setImageResource(R.mipmap.ic_volume_max);
